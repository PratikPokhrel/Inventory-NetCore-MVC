function ProductCardList(params) {
    var _Params = params;
    console.log(_Params);
    var _ObjectReference = this;

    _Params.Type = "ProductCardList";
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        document.location.href = "/Product/Product/Card_Index";
                    } else {
                        $.notify(response.message, { globalposition: 'top center', className: 'success' });
                    }
                }
    ...
    _Params.SearchURL = APPLICATION_PATH +"/Product/Product/Search_Card";
    _Params.SearchFormID = "FormSearchProductCardList";
